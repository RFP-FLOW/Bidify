...
import { LayoutDashboard, FilePlus, Gavel, LogOut, Sun, Moon, FileText } from "lucide-react";
    ...
    <aside className="h-screen w-[260px] flex flex-col justify-between sticky top-0 transition-colors duration-300 bg-card" style={{ borderRight: "1px solid var(--border-color)" }}>
      ...
      <div className="px-5 pt-7 pb-4">
        <div className="flex items-center gap-3 mb-10 px-2">
          ...
          <div><span className="t-primary text-[15px] font-bold tracking-[-0.02em] block leading-tight">Bidify</span><span className="t-muted text-[11px] font-medium">RFP Portal</span></div>
        </div>
